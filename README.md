...
The config file under /eval/ is the key file for INMAP simulation. Once you customize it for your INMAP simulations (e.g., emissions file path), you can run this command in the main directory: "./inmap run steady -s --config /Users/yunhalee/Documents/LOCAETA/RCM/INMAP/inmap-1.9.6-gridsplit/eval/nei2020Config_LA_CCS.toml". If you run this model in your macbook, please add "caffeinate -i" beofre "./inmap run steady -s ....". 
